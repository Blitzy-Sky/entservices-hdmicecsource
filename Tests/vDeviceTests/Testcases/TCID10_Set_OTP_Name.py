 ...
 * @brief L3 vDevice testcase for the HDMI-CEC Source plugin. Sets the OSD name.
 *
 * @testcase TCID10_Set_OTP_Name
 * @details Invokes setOSDName with a name and checks the plugin reports success.
 *
 * @precondition
 ...
 *
 * @expected_result
 *  - org.rdk.HdmiCecSource.setOSDName answers with the values this scenario expects.
 *
 * @pass_criteria
