 ...
 * @brief L3 vDevice testcase for the HDMI-CEC Source plugin. Disables CEC and restores it.
 *
 * @testcase TCID08_Set_Enabled_False
 * @details Invokes setEnabled with false, then restores the enabled state with setEnabled true so
 *          the suite leaves CEC as it found it.
 *
 * @precondition
 ...
 *
 * @expected_result
 *  - org.rdk.HdmiCecSource.setEnabled answers with the values this scenario expects.
 *
 * @pass_criteria
