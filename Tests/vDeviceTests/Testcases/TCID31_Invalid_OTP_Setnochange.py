 ...
 * @brief L3 vDevice testcase for the HDMI-CEC Source plugin. An invalid one-touch-play value must
 *        not change the stored setting.
 *
 * @testcase TCID31_Invalid_OTP_Setnochange
 * @details Enables OTP and reads it back, then sets an invalid value and checks getOTPEnabled
