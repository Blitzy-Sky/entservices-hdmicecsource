 ...
 * @brief L3 vDevice testcase for the HDMI-CEC Source plugin. Reads the OSD name.
 *
 * @testcase TCID15_Get_OSD_Name
 * @details Invokes getOSDName and checks the reported name is returned with success.
 *
 * @precondition
 ...
 *
 * @expected_result
 *  - org.rdk.HdmiCecSource.getOSDName answers with the values this scenario expects.
 *
 * @pass_criteria
