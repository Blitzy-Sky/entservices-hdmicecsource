 ...
 * @brief L3 vDevice testcase for the HDMI-CEC Source plugin. Disables one-touch-play.
 *
 * @testcase TCID11_Set_OTP_Enabled_False
 * @details Invokes setOTPEnabled with false and checks the plugin reports success.
 *
 * @precondition
