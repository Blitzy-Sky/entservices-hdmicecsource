 ...
 * @brief L3 vDevice testcase for the HDMI-CEC Source plugin. Device add and remove through the
 *        vComponent.
 *
 * @testcase TCID21_Add_Remove_Device_Vcomponent
 * @details Adds and then removes an emulated peer through the vComponent and checks getDeviceList
 ...
 *  - vcomponent_configurations/commands/ - Device_Add.yaml, Device_CEC_Message.yaml,
 *    Device_Remove.yaml, Device_Status.yaml
 *
 * @expected_result
