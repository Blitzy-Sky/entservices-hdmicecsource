 ...
 * @brief L3 vDevice testcase for the HDMI-CEC Source plugin. Sends a Standby message on the CEC
 *        bus.
 *
 * @testcase TCID01_Send_Standby_Message
 * @details Invokes sendStandbyMessage for a target logical address and checks the plugin reports
 *          success.
 *
 * @precondition
