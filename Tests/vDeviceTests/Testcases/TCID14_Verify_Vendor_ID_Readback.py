 ...
 * @brief L3 vDevice testcase for the HDMI-CEC Source plugin. Reads the vendor ID back.
 *
 * @testcase TCID14_Verify_Vendor_ID_Readback
 * @details Invokes getVendorId and checks the reported vendorid matches the value the suite
 *          expects.
 *
 * @precondition
